...
struct Stg_Momentum_EURUSD_M15_Params : Stg_Momentum_Params {
  Stg_Momentum_EURUSD_M15_Params() {
    symbol = "EURUSD";
    tf = PERIOD_M15;
    Momentum_Period = 2;
