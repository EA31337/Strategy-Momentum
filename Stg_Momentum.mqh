...
class Stg_Momentum : public Strategy {
 public:
  ...
  static Stg_Momentum *Init_M1() {
    ...
    StgParams mom1_sparams(new Trade(PERIOD_M1, _Symbol), new Indi_Momentum(mom1_iparams, mom_iparams, cparams1), NULL,
                           NULL);
    mom1_sparams.SetSignals(Momentum1_SignalMethod, Momentum1_OpenCondition1, Momentum1_OpenCondition2,
                            Momentum1_CloseCondition, NULL, Momentum_SignalLevel, NULL);
  ...
  static Stg_Momentum *Init_M5() {
    ...
    StgParams mom5_sparams(new Trade(PERIOD_M5, _Symbol), new Indi_Momentum(mom5_iparams, mom_iparams, cparams5), NULL,
                           NULL);
    mom5_sparams.SetSignals(Momentum5_SignalMethod, Momentum5_OpenCondition1, Momentum5_OpenCondition2,
                            Momentum5_CloseCondition, NULL, Momentum_SignalLevel, NULL);
  ...
  static Stg_Momentum *Init_M15() {
    ...
    StgParams mom15_sparams(new Trade(PERIOD_M15, _Symbol), new Indi_Momentum(mom15_iparams, mom_iparams, cparams15),
                            NULL, NULL);
    mom15_sparams.SetSignals(Momentum15_SignalMethod, Momentum15_OpenCondition1, Momentum15_OpenCondition2,
                             Momentum15_CloseCondition, NULL, Momentum_SignalLevel, NULL);
  ...
  static Stg_Momentum *Init_M30() {
    ...
    StgParams mom30_sparams(new Trade(PERIOD_M30, _Symbol), new Indi_Momentum(mom30_iparams, mom_iparams, cparams30),
                            NULL, NULL);
    mom30_sparams.SetSignals(Momentum30_SignalMethod, Momentum30_OpenCondition1, Momentum30_OpenCondition2,
                             Momentum30_CloseCondition, NULL, Momentum_SignalLevel, NULL);
